...
CREATE TABLE RECTIFICATION_TEMP(
    ID INT AUTO_INCREMENT,
    PETITION_ID INT NOT NULL,
    CLIENT_ID INT NOT NULL,
    NEW_NAME VARCHAR(50) NOT NULL,
    NEW_FIRST_LASTNAME VARCHAR(50) NOT NULL,
    NEW_SECOND_LASTNAME VARCHAR (50) NOT NULL,
    NEW_BIRTHDATE DATE NOT NULL,
    NEW_NATIONALITY VARCHAR(50),
    NEW_STATE_OF_BIRTH VARCHAR(50),
    NEW_CURP VARCHAR(18) NOT NULL,
    NEW_ECONOMIC_ACTIVITY VARCHAR(50),
    NEW_GENDER VARCHAR(2),
    NEW_PHONE_NUMBER VARCHAR(13),
...
ALTER TABLE RECTIFICATION_TEMP ADD FOREIGN KEY(CLIENT_ID) REFERENCES CLIENT(CLIENT_ID);
ALTER TABLE RECTIFICATION_TEMP ADD FOREIGN KEY(PETITION_ID) REFERENCES ARCO_PETITIONS(PETITION_ID);
...
INSERT INTO CLIENT (CLIENT_NAME, CLIENT_FIRST_LASTNAME, CLIENT_SECOND_LASTNAME, CLIENT_BIRTHDATE, CLIENT_CURP, CLIENT_GENDER, CLIENT_PHONE_NUMBER, CLIENT_EMAIL, IS_CLIENT, IS_BLOCKED, IS_IN_OPOSITION, CREATED_AT, UPDATED_AT, DELETED_AT)
VALUES ('Jane', 'Doe', ' ', '1995-05-05', 'EFGH123456IJKL90', 'F', '+525555555556', 'jane.doe@example.com', 1, 0, 0, NOW(), NULL, NULL);


INSERT INTO CLIENT (CLIENT_NAME, CLIENT_FIRST_LASTNAME, CLIENT_SECOND_LASTNAME, CLIENT_BIRTHDATE, CLIENT_CURP, CLIENT_GENDER, CLIENT_PHONE_NUMBER, CLIENT_EMAIL, IS_CLIENT, IS_BLOCKED, IS_IN_OPOSITION, CREATED_AT, UPDATED_AT, DELETED_AT)
VALUES ('Bob', 'Smith', ' ', '1985-08-08', 'MNOP123456QRST56', 'M', '+525555555557', 'bob.smith@example.com', 1, 0, 0, NOW(), NULL, NULL);
